  ...
  return (
    <main id="main-content" className="services-page page-main">
      <header className="services-intro page-shell section-pad">
        <div className="services-intro__image media-frame">
          <Image
            src="/images/projects/residential/living-arifin.webp"
            alt="Light-filled residential living room with integrated storage"
            fill
            priority
        ...
        <div className="services-intro__copy">
          <p className="eyebrow">Interior design & build</p>
      ...
      <nav className="services-index page-shell" aria-label="Services on this page">
        {serviceGroups.map((group) => <Link href={"/services#" + group.id} key={group.id}>{group.title}</Link>)}
      </nav>
